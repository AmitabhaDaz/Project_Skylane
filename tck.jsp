...
//OutputStream os=response.getOutputStream();
 ...
 Statement st=con.createStatement();
  ...
  doc.add( new Paragraph("-------------------------------------FLY-LANE BOOKING SYSTEM------------------------------------"));
  doc.add(new Paragraph("      "));
    doc.add( new Paragraph("--------------------------------------------------------TICKET---------------------------------------------"));
         ...
         float[] columnWidths = {1.5f, 1.5f, 1.5f, 1.5f, 1f, 1.5f, 1.5f};
        	 ...
        	 doc.add( new Paragraph("DESTINATION:"));
        	 doc.add(new Paragraph(d));
        	 doc.add( new Paragraph("SEAT NUMBER:"));
        	 doc.add(new Paragraph(ss));
        	 doc.add( new Paragraph("PRICE:"));
        	 doc.add(new Paragraph("Rs: 8999 only"));
